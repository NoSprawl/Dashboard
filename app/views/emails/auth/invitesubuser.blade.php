		...
		<table cellspacing="0" cellpadding="0" width="100%">
			<tr>
				...
				<td style="background: #eee; padding-top: 4px; padding-bottom: 4px;">
					...
					<div style="display: block; font-family: Helvetica, Arial; font-size: 1em; color: #343434; line-height: 1.7em; margin-top: 0; padding-top: 0;">Please <a href="<?= (App::isLocal() ? 'http://localhost:8000/signup/' : 'http://my.nosprawl.com/signup/') ?><?= $data['user_confirmation_token']; ?>">activate your account now</a>.</div>
