		...
		<tbody>
			<?php foreach($integrations as $integration) { ?>
				<tr data-integration-id="<?= $integration->id; ?>">
					...
					<td><a data-method="post" href="/integration/delete/<?php echo $integration['id'] ?>">Delete</a><?php if (App::isLocal()) { ?> | <a data-method="post" href="/integration/enqueueJobs/<?php echo $integration['id'] ?>">Check Queue</a><?php } ?></td>
				</tr>
			<?php } ?>
		</tbody>
	</table>
